...
namespace PlantillaBlazor.Persistence.Migrations
{
    ...
    [Migration("20250525235516_AddCamposProductos")]
    partial class AddCamposProductos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlantillaBlazor.Domain.Entities.GaiaCaporal.Carrito", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("Carrito", "Ope");
                });

            modelBuilder.Entity("PlantillaBlazor.Domain.Entities.GaiaCaporal.DetallePedido", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("DetallePedido", "Ope");
                });

            modelBuilder.Entity("PlantillaBlazor.Domain.Entities.GaiaCaporal.Producto", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PlantillaBlazor.Domain.Entities.GaiaCaporal.Producto", b =>
                {
                    b.HasOne("PlantillaBlazor.Domain.Entities.GaiaCaporal.Carrito", null)
                        .WithMany("ListaProductos")
                        .HasForeignKey("CarritoId");

                    b.HasOne("PlantillaBlazor.Domain.Entities.Parametrizacion.ParametroDetallado", "Categoria")
                        .WithMany("ListaProductos")
                        .HasForeignKey("CategoriaId");

                    b.HasOne("PlantillaBlazor.Domain.Entities.Perfilamiento.Usuario", "Mercado")
                        .WithMany()
