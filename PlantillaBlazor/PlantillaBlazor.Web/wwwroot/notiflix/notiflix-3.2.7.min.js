...
(function (t, e) {
    ...
    var e,
        ...
        l = { Success: "Success", Failure: "Failure", Warning: "Warning", Info: "Info" },
        c = {
        ...
        m = { Success: "Success", Failure: "Failure", Warning: "Warning", Info: "Info" },
        p = {
            ...
            cssAnimationStyle: "fade",
            success: { svgColor: "#32c682", titleColor: "#1e1e1e", messageColor: "#242424", buttonBackground: "#32c682", buttonColor: "#fff", backOverlayColor: "rgba(50,198,130,0.2)" },
            failure: { svgColor: "#ff5549", titleColor: "#1e1e1e", messageColor: "#242424", buttonBackground: "#ff5549", buttonColor: "#fff", backOverlayColor: "rgba(255,85,73,0.2)" },
            warning: { svgColor: "#eebf31", titleColor: "#1e1e1e", messageColor: "#242424", buttonBackground: "#eebf31", buttonColor: "#fff", backOverlayColor: "rgba(238,191,49,0.2)" },
            info: { svgColor: "#26c0d3", titleColor: "#1e1e1e", messageColor: "#242424", buttonBackground: "#26c0d3", buttonColor: "#fff", backOverlayColor: "rgba(38,192,211,0.2)" },
        },
        ...
        x = { Standard: "Standard", Hourglass: "Hourglass", Circle: "Circle", Arrows: "Arrows", Dots: "Dots", Pulse: "Pulse", Custom: "Custom", Notiflix: "Notiflix" },
        g = {
        ...
        u = { Standard: "Standard", Hourglass: "Hourglass", Circle: "Circle", Arrows: "Arrows", Dots: "Dots", Pulse: "Pulse" },
        b = {
        ...
        E = function (a, n, o, s) {
            ...
            F++,
                ...
                ((e = v(!0, e, { closeButton: !0, messageMaxLength: 150 })), (n = 'Possible HTML Tags Error: The "plainText" option is "false" and the notification content length is more than the "messageMaxLength" option.')),
                n.length > e.messageMaxLength && (n = n.substring(0, e.messageMaxLength) + "..."),
                "shadow" === e.fontAwesomeIconStyle && (d.fontAwesomeIconColor = d.background),
            ...
            if (
                ((f.id = c.wrapID),
                    ...
                    "center-center" === e.position
                        ...
                        : "center-top" === e.position
                            ? ((f.style.left = e.distance), (f.style.right = e.distance), (f.style.top = e.distance), (f.style.bottom = "auto"), (f.style.margin = "auto"))
                            : "center-bottom" === e.position
                                ? ((f.style.left = e.distance), (f.style.right = e.distance), (f.style.bottom = e.distance), (f.style.top = "auto"), (f.style.margin = "auto"))
                                : "right-bottom" === e.position
                                    ? ((f.style.right = e.distance), (f.style.bottom = e.distance), (f.style.top = "auto"), (f.style.left = "auto"))
                                    : "left-top" === e.position
                                        ? ((f.style.left = e.distance), (f.style.top = e.distance), (f.style.right = "auto"), (f.style.bottom = "auto"))
                                        : "left-bottom" === e.position
                                            ? ((f.style.left = e.distance), (f.style.bottom = e.distance), (f.style.top = "auto"), (f.style.right = "auto"))
                                            : ((f.style.right = e.distance), (f.style.top = e.distance), (f.style.left = "auto"), (f.style.bottom = "auto")),
                    e.backOverlay)
            ) {
                ...
                (x.id = c.overlayID),
                    ...
                    (x.style.animationDuration = e.cssAnimation ? e.cssAnimationDuration + "ms" : ""),
                    t.document.getElementById(c.overlayID) || t.document.body.appendChild(x);
            }
            ...
            (g.id = e.ID + "-" + F),
                (g.className =
                    ...
                    e.cssAnimationStyle +
                    " " +
                    (e.closeButton && "function" != typeof o ? "nx-with-close-button" : "") +
                    " " +
                ...
                e.cssAnimation && (g.style.animationDuration = e.cssAnimationDuration + "ms");
            var u = "";
            if (
                (e.closeButton &&
                    "function" != typeof o &&
                ...
                g.innerHTML = '<span class="nx-message">' + n + "</span>" + (e.closeButton ? u : "");
                ...
                g.innerHTML =
                    ...
                    " " +
                    ("shadow" === e.fontAwesomeIconStyle ? "nx-message-icon-fa-shadow" : "nx-message-icon-fa-basic") +
                ...
                a === l.Success
                    ...
                    (g.innerHTML = b + '<span class="nx-message nx-with-icon">' + n + "</span>" + (e.closeButton ? u : ""));
            }
        ...
        H = function (e, n, i, o, s, l) {
            ...
            "string" != typeof n && (n = "Notiflix " + e),
                "string" != typeof i &&
                (e === m.Success
                    ? (i = '"Do not try to become a person of success but try to become a person of value." <br><br>- Albert Einstein')
                    : e === m.Failure
                        ? (i = '"Failure is simply the opportunity to begin again, this time more intelligently." <br><br>- Henry Ford')
                        : e === m.Warning
                            ? (i = '"The peoples who want to live comfortably without producing and fatigue; they are doomed to lose their dignity, then liberty, and then independence and destiny." <br><br>- Mustafa Kemal Ataturk')
                            : e === m.Info && (i = '"Knowledge rests not upon truth alone, but upon error also." <br><br>- Carl Gustav Jung')),
                "string" != typeof o && (o = "Okay"),
                a.plainText && ((n = N(n)), (i = N(i)), (o = N(o))),
                a.plainText ||
                (n.length > a.titleMaxLength && ((n = "Possible HTML Tags Error"), (i = 'The "plainText" option is "false" and the title content length is more than the "titleMaxLength" option.'), (o = "Okay")),
                    i.length > a.messageMaxLength && ((n = "Possible HTML Tags Error"), (i = 'The "plainText" option is "false" and the message content length is more than the "messageMaxLength" option.'), (o = "Okay")),
                    o.length > a.buttonMaxLength && ((n = "Possible HTML Tags Error"), (i = 'The "plainText" option is "false" and the button content length is more than the "buttonMaxLength" option.'), (o = "Okay"))),
                n.length > a.titleMaxLength && (n = n.substring(0, a.titleMaxLength) + "..."),
                i.length > a.messageMaxLength && (i = i.substring(0, a.messageMaxLength) + "..."),
                o.length > a.buttonMaxLength && (o = o.substring(0, a.buttonMaxLength) + "..."),
            ...
            var b = "";
            if (
                (e === m.Success ? (b = C(a.svgSize, f.svgColor)) : e === m.Failure ? (b = z(a.svgSize, f.svgColor)) : e === m.Warning ? (b = S(a.svgSize, f.svgColor)) : e === m.Info && (b = L(a.svgSize, f.svgColor)),
                    (x.innerHTML =
                        g +
                        '<div class="' +
                        a.className +
        ...
        j = function (e, a, i, o, s, l, c, m, p) {
            ...
            "object" != typeof p || Array.isArray(p) || (n = v(!0, n, p)),
                ...
                n.plainText ||
                (a.length > n.titleMaxLength && ((a = "Possible HTML Tags Error"), (i = 'The "plainText" option is "false" and the title content length is more than "titleMaxLength" option.'), (s = "Okay"), (l = "...")),
                    i.length > n.messageMaxLength && ((a = "Possible HTML Tags Error"), (i = 'The "plainText" option is "false" and the message content length is more than "messageMaxLength" option.'), (s = "Okay"), (l = "...")),
                    (s.length || l.length) > n.buttonsMaxLength &&
                    ((a = "Possible HTML Tags Error"), (i = 'The "plainText" option is "false" and the buttons content length is more than "buttonsMaxLength" option.'), (s = "Okay"), (l = "..."))),
                a.length > n.titleMaxLength && (a = a.substring(0, n.titleMaxLength) + "..."),
                i.length > n.messageMaxLength && (i = i.substring(0, n.messageMaxLength) + "..."),
                s.length > n.buttonsMaxLength && (s = s.substring(0, n.buttonsMaxLength) + "..."),
                l.length > n.buttonsMaxLength && (l = l.substring(0, n.buttonsMaxLength) + "..."),
                n.cssAnimation || (n.cssAnimationDuration = 0);
            var g = t.document.createElement("div");
            (g.id = f.ID),
                (g.className = n.className + (n.cssAnimation ? " nx-with-animation nx-" + n.cssAnimationStyle : "")),
            ...
            var y = "";
            "function" == typeof c &&
                (y = '<a id="NXConfirmButtonCancel" class="nx-confirm-button-cancel" style="color:' + n.cancelButtonColor + ";background:" + n.cancelButtonBackground + ";font-size:" + n.buttonsFontSize + ';">' + l + "</a>");
            var h = "",
                w = null,
                C = void 0;
        ...
        V = function (e, a, n, o, s) {
            ...
            if (("string" == typeof a && 0 < a.length && (m = a), o)) {
                ...
                if (
                    ((w.id = g.ID),
                        (w.className = i.className + (i.cssAnimation ? " nx-with-animation" : "") + (i.clickToClose ? " nx-loading-click-to-close" : "")),
                        ...
                        i.rtl && (w.setAttribute("dir", "rtl"), w.classList.add("nx-rtl-on")),
                        (w.innerHTML = h + p),
                        !t.document.getElementById(w.id) && (t.document.body.appendChild(w), i.clickToClose))
                ) {
                    ...
                    if (((S = c[D]), S)) {
                        ...
                        if (1 > T.length) {
                            ...
                            var E = '<span class="' + g + '-icon" style="width:' + o.svgSize + ";height:" + o.svgSize + ';">' + F + "</span>",
                                O = "";
                            0 < x.length &&
                                ((x = x.length > o.messageMaxLength ? N(x).substring(0, o.messageMaxLength) + "..." : N(x)),
                                    (O = '<span style="font-size:' + o.messageFontSize + ";color:" + o.messageColor + ';" class="' + g + '-message">' + x + "</span>")),
                                U++;
                            var H = t.document.createElement("div");
                            (H.id = b.ID + "-" + U),
                                (H.className = g + (o.cssAnimation ? " nx-with-animation" : "")),
                                ...
                                o.rtl && (H.setAttribute("dir", "rtl"), H.classList.add("nx-rtl-on")),
                                (H.innerHTML = E + O);
                ...
                var _ = function (e) {
                    ...
                    tt = function (t) {
                        if (t && 0 < t.length) for (var e, a = 0; a < t.length; a++) (e = t[a]), e && (e.classList.add("nx-remove"), _(e));
                            ...
                            "string" == typeof n
                                ? h('"Notiflix.Block.remove();" function called with "' + n + '" selector, but this selector does not have a "Block" element to remove.')
                                : h('"Notiflix.Block.remove();" function called with "' + n + '", but this "Array<HTMLElement>" or "NodeListOf<HTMLElement>" does not have a "Block" element to remove.');
                    },
                    et = function (t) {
    ...
    return { Notify: G.Notify, Report: G.Report, Confirm: G.Confirm, Loading: G.Loading, Block: G.Block };
});
